...
"}")
        ...
        self.Welcome.setGeometry(QtCore.QRect(180, 70, 391, 61))
        font = QtGui.QFont()
...
"")
        ...
        self.HomeLabel = QtWidgets.QPushButton(Student_Dialog)
        self.HomeLabel.setGeometry(QtCore.QRect(310, 590, 91, 41))
        font = QtGui.QFont()
        font.setFamily("Segoe UI,sans-serif")
        font.setBold(True)
        font.setWeight(75)
        self.HomeLabel.setFont(font)
        self.HomeLabel.setStyleSheet("QPushButton {\n"
"    background-color: #FAFAD2; /* Gold */\n"
"    color: #0B1D3A;\n"
"    border: none;\n"
"    border-radius: 10px;\n"
...
"}")
    ...
    def retranslateUi(self, Student_Dialog):
        ...
        self.HomeLabel.setText(_translate("Student_Dialog", "Home"))


if __name__ == "__main__":
    import sys
    app = QtWidgets.QApplication(sys.argv)
    Student_Dialog = QtWidgets.QDialog()
    ui = Ui_Student_Dialog()
    ui.setupUi(Student_Dialog)
    Student_Dialog.show()
    sys.exit(app.exec_())
